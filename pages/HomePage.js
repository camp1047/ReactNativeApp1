    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <TouchableOpacity
      onPress={() => navigation.navigate("About")} // Navigates to 'List' page
...
const styles = StyleSheet.create({
  ...
  buttonText: {
    position: "absolute", // Overlay text on top of SVG
    color: "#fff",
    fontWeight: "bold",
    fontSize: 18,
    top: 70,
  ...
  overlay: { //makes the background darker
    position: "absolute",
    top: 0,
    left: 0,
    right: 0,
  ...
  alertContainer: { //makes the alert box
  ...
  optionsContainer: { //makes the buttons in the alert box next to each other
